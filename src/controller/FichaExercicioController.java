...
public class FichaExercicioController {
    ...
    public void adicionarExercicio(int idFicha, int idExercicio, int series, int repeticoes) {
        FichaExercicio fe = new FichaExercicio(idFicha, idExercicio, series, repeticoes);
        fichaExercicioDAO.inserir(fe);
        System.out.println("Exercício adicionado à ficha com sucesso.");
    }

    public void atualizarExercicioFicha(int idFicha, int idExercicio, int novasSeries, int novasRepeticoes) {
        FichaExercicio fe = new FichaExercicio(idFicha, idExercicio, novasSeries, novasRepeticoes);
